...
h = adftest(x1ro); % teste de estacionaridade da série regularizada
...
%1.6
%simulação do modelo ar (estimar componente sazonal)
%y(t) + a1*y(t-1) a a2*y(t-2) +...+ aN*y(t-N)
%Logo os primeiros N elementos Não sao alterados
